// MyInvois e-Invoice classification codes.
...
export const CLASSIFICATION_CODES = {
  ...
  '043': 'Mortgage interest',
  '044': 'EV charging facilities for personal use',
  '045': 'Pet food',
} as const;

export type ClassificationCode = keyof typeof CLASSIFICATION_CODES;
